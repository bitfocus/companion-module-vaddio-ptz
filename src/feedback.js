...
export function updateFeedbacks() {
	...
	feedbacks['standby'] = {
		...
		callback: ({ options }) => {
			if (this.state.standby == options.mode) {
				return true
			} else {
				return false
			}
	...
	feedbacks['auto_focus'] = {
		...
		options: [Fields.OnOff],
		callback: ({ options }) => {
			if (this.state.auto_focus == options.mode) {
				return true
			} else {
				return false
			}
	...
	feedbacks['auto_iris'] = {
		...
		options: [Fields.OnOff],
		callback: ({ options }) => {
			if (this.state.auto_iris == options.mode) {
				return true
			} else {
				return false
			}
	...
	feedbacks['auto_white_balance'] = {
		...
		options: [Fields.OnOff],
		callback: ({ options }) => {
			if (this.state.auto_white_balance == options.mode) {
				return true
			} else {
				return false
			}
	...
	feedbacks['backlight_compensation'] = {
		...
		options: [Fields.OnOff],
		callback: ({ options }) => {
			if (this.state.backlight_compensation == options.mode) {
				return true
			} else {
				return false
			}
	...
	feedbacks['led'] = {
		...
		options: [Fields.OnOff],
		callback: ({ options }) => {
			if (this.state.led == options.mode) {
				return true
			} else {
				return false
			}
	...
	feedbacks['mute'] = {
		...
		options: [Fields.OnOff],
		callback: ({ options }) => {
			if (this.state.mute == options.mode) {
				return true
			} else {
				return false
			}
	...
	feedbacks['pt_speed'] = {
		...
		callback: ({ options }) => {
			if (this.panSpeed == options.panSpeed && this.tiltSpeed == options.tiltSpeed) {
				return true
			} else {
				return false
			}
	...
	feedbacks['wide_dynamic_range'] = {
		...
		options: [Fields.OnOff],
		callback: ({ options }) => {
			if (this.state.wide_dynamic_range == options.mode) {
				return true
			} else {
				return false
			}
